<html>
  <head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; style-src 'unsafe-inline'; img-src 'self'; connect-src 'self'">
    <title>Page not found &middot; 02.soarn.pro</title>
